...
(function () {
  ...
  const STRINGS = {
    hr: { title: 'ST Arc Asistent', placeholder: 'Postavi pitanje...', send: 'Pošalji', greeting: 'Bok! 👋 Ja sam ST Arc asistent. Kako vam mogu pomoći? Tu sam za vas!', thinking: 'Razmišljam...', error: 'Oprostite, došlo je do greške. Pokušajte ponovno.', sources: 'Izvori', contact: 'Kontakt' },
    en: { title: 'ST Arc Assistant', placeholder: 'Ask a question...', send: 'Send', greeting: 'Hi! 👋 I\'m the ST Arc assistant. How can I help you? I\'m here for you!', thinking: 'Thinking...', error: 'Sorry, something went wrong. Please try again.', sources: 'Sources', contact: 'Contact' },
    de: { title: 'ST Arc Assistent', placeholder: 'Stellen Sie eine Frage...', send: 'Senden', greeting: 'Hallo! 👋 Ich bin der ST Arc Assistent. Wie kann ich dir helfen? Ich bin für dich da!', thinking: 'Denke nach...', error: 'Entschuldigung, etwas ist schief gelaufen.', sources: 'Quellen', contact: 'Kontakt' },
    it: { title: 'Assistente ST Arc', placeholder: 'Fai una domanda...', send: 'Invia', greeting: 'Ciao! 👋 Sono l\'assistente ST Arc. Come posso aiutarti? Sono qui per te!', thinking: 'Sto pensando...', error: 'Spiacenti, si è verificato un errore.', sources: 'Fonti', contact: 'Contatto' },
    es: { title: 'Asistente ST Arc', placeholder: 'Haz una pregunta...', send: 'Enviar', greeting: '¡Hola! 👋 Soy el asistente de ST Arc. ¿Cómo puedo ayudarte? ¡Estoy aquí para ti!', thinking: 'Pensando...', error: 'Lo siento, algo salió mal.', sources: 'Fuentes', contact: 'Contacto' },
    fr: { title: 'Assistant ST Arc', placeholder: 'Posez une question...', send: 'Envoyer', greeting: 'Salut! 👋 Je suis l\'assistant ST Arc. Comment puis-je vous aider? Je suis là pour vous!', thinking: 'Je réfléchis...', error: 'Désolé, une erreur s\'est produite.', sources: 'Sources', contact: 'Contact' },
    nl: { title: 'ST Arc Assistent', placeholder: 'Stel een vraag...', send: 'Verstuur', greeting: 'Hoi! 👋 Ik ben de ST Arc assistent. Hoe kan ik je helpen? Ik ben hier voor jou!', thinking: 'Aan het denken...', error: 'Sorry, er ging iets mis.', sources: 'Bronnen', contact: 'Contact' },
    pt: { title: 'Assistente ST Arc', placeholder: 'Faça uma pergunta...', send: 'Enviar', greeting: 'Olá! 👋 Sou o assistente ST Arc. Como posso ajudá-lo? Estou aqui para você!', thinking: 'A pensar...', error: 'Desculpe, algo correu mal.', sources: 'Fontes', contact: 'Contacto' },
    ru: { title: 'Ассистент ST Arc', placeholder: 'Задайте вопрос...', send: 'Отправить', greeting: 'Привет! 👋 Я ассистент ST Arc. Как я могу вам помочь? Я здесь для вас!', thinking: 'Думаю...', error: 'Извините, произошла ошибка.', sources: 'Источники', contact: 'Контакт' },
    zh: { title: 'ST Arc 助手', placeholder: '提出问题...', send: '发送', greeting: '你好! 👋 我是 ST Arc 助手。我如何能帮助你？我在这里为你服务！', thinking: '思考中...', error: '抱歉，出现了错误。', sources: '来源', contact: '联系' },
    ar: { title: 'مساعد ST Arc', placeholder: 'اطرح سؤالاً...', send: 'إرسال', greeting: 'مرحباً! 👋 أنا مساعد ST Arc. كيف يمكنني مساعدتك؟ أنا هنا من أجلك!', thinking: 'أفكر...', error: 'عذراً، حدث خطأ.', sources: 'المصادر', contact: 'اتصال' },
  };
